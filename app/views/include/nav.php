<div class="dynamic-nav" data-state=<?= isset($_SESSION['user_id']) ? 'login' : 'none' ?>>
    <ul class="hnav">
        <li><a href="index.php?page=home" class="<?= ($page === 'home') ? 'selected' : '' ?>">Home</a></li>
        <li><a href="index.php?page=product" class="<?= ($page === 'product') ? 'selected' : '' ?>">Product</a></li>
        <li><a href="index.php?page=about" class="<?= ($page === 'about') ? 'selected' : '' ?>">About</a></li>
        <li id="logout-btn" style="display: none;"><a href="index.php?page=logout">Logout</a></li>
    </ul>
</div>
